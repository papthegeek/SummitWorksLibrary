...
<form action="DisplayTransactionServlet" method="get" onsubmit="return validateForm()">

	<table align="center" border="2" cellspacing="2" cellpadding="2" width="40%">

		<tr align="center"><td colspan="2" ><h2>Transactions</h2></td></tr>
		<tr><td width="10%">Member Id :</td><td width="30%"><input type="text" name="memberId" id="id"></td></tr>
		<tr align="center"><td colspan="2" ><input type="submit" value="Display Transactions"></td></tr>
