...
<form action="/Library1/DeleteBook" method="post">
<input type="hidden" name="id" value="<%=book.getId()%>" style="height: 0cm; width: 0cm;">
...
<tr><td>Total :</td><td><%=book.getTotal()%></td></tr>
<tr><td>Available :</td><td><%=book.getAvailable()%></td></tr>

<tr align="center"><td colspan="2" ><input type="submit" value="Delete"></td></tr>
<h3><a style="color: highlighttext; color:maroon; font-style:oblique; font-family:cursive;" href="DeleteBook.jsp">Cancel</a><br></h3>
