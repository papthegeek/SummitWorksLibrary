...
<form action="/Library1/DeleteBookServlet" method="get" onsubmit="return validateForm()">

<table align="center" border="2" cellspacing="2" cellpadding="2" width="40%">

<tr align="center"><td colspan="2" ><h2>Deleting a Book</h2></td></tr>

<tr><td width="10%">Book Id :</td><td width="30%"><input type="text" name="id" id="id"></td></tr>
